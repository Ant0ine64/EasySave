...
namespace EasySaveConsole.View
{
    ...
    public class Prompt
    {
        ...
        private bool promptMainMenu(string option)
        {
            ...
            switch(option)
            {
                case "0": // cr�er un travail de sauvegarde 
        ...
        private string makeMenu(string title, string[] message)
        {
            ...
            while (keepTurning)
            {
                ...
                else
                {
                    ...
                    if (keepTurning == true)
                    {
                        Console.WriteLine(Properties.Resources.user_input_error); // red�marre la boucle si la saisie est invalide 
                    }
                }
            }
            return result;
        ...
        private string makeMenu(string title, string[] message, string[] option)
        {
            ...
            while (keepTurning)
            {
                ...
                // v�rifie le choix de l'utilisateur
                if (result == "x")
                {
                    keepTurning = false; // quitte la boucle
                }
